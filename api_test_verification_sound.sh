...
f_test_extract () {
    ...
    f_check -r 400 -m "BPE-003002" -f "Error expected BPE-003002"
    ...
    f_check -r 400 -m "BPE-003003" -f "Error expected BPE-003003"
...
f_test_verify() {
    ...
    f_check -r 400 -m "BPE-00200[3-4]"  -f "Error expected BPE-00200[3-4]"
    ...
    f_check -r 400 -m "BPE-003001"  -f "Error expected BPE-003001"
    ...
    f_check -r 400 -m "BPE-002005"  -f "Error expected BPE-002005"
