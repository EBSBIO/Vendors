...
CMD='screen -dmS start.jmeter sh -c "'$JPATH'/jmeter -n -t '$JMX_FILE' -Jthreads='${3}' -Jloop='$JLOOP' -JRamp='$JRAMP' -Jtask='$JTASK' -Jcontent_type='$CTYPE' -Jdata='$SAMPLE' -Jvendor='$VENDOR_URL' -l '$JREPORT' >> '$JOUT'"'
