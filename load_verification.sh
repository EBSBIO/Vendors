...
# Запуск
CMD=$JPATH'/jmeter -n -t '$JMX_FILE' -Jthreads='$THREADS' -Jloop='$LOOP' -JRamp='$RAMP' -Jtask='$JTASK' -Jcontent_type='$CTYPE' -Jdata='$SAMPLE' -Jvendor='$VENDOR_URL' -Jperflog='$JPERFLOG' -j '$JLOG' -l '$JREPORT
